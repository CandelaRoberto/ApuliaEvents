...
export function useEliminaPost(onUpdatedPosts) {
    ...
    const handleConfirmDelete = async () => {
        ...
        await fetch(`https://apuliaevents.onrender.com/api/post/posts/${postToDelete._id}`, {
            method: "DELETE",
            credentials: "include",
        });
        ...
        try {
            const res = await fetch("https://apuliaevents.onrender.com/api/notifiche/notifiche", {
                credentials: "include",
            });
