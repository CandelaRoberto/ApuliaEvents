...
export default function Sidebar({
  ...
  try {
    const r = await fetch("https://apuliaevents.onrender.com/api/messaggi/Conversazioni", {
      credentials: "include"
    });
  ...
  const drawerContent = (
    ...
    >
      <List>
        ...
        // Segna come letti
        await fetch(`https://apuliaevents.onrender.com/api/messaggi/SegnaComeLetto/${utente._id}`, {
            method: "PUT",
            credentials: "include",
        });
